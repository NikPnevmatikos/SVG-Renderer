...
describe('matrix', () => {
  ...
  it('formats matrices for SVG output', () => {
    expect(formatMatrix([1, 0, 0, 1, 10.5, -0.0000001], 6)).toBe('matrix(1 0 0 1 10.5 0)');
    expect(formatMatrix([1, 0, 0, 1, 10.5, -0.0000001])).toBe('matrix(1 0 0 1 10.5 -1e-7)');
    expect(formatMatrix([0.9975640502598242, -0.0697564737441253, 0.0697564737441253, 0.9975640502598242, 490, 60])).toBe(
      'matrix(0.9975640502598242 -0.0697564737441253 0.0697564737441253 0.9975640502598242 490 60)'
    );
  });
});
